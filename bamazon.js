...
var bamazon = {
    ...
    initInq: function(inq) {
        inq.prompt([{
            ...
            if (isNaN(data.item) === false) {
                var item = data.item;
                bamazon.initQuant(inq, item); // how much you want
            }
    ...
    initQuant: function(inq, item) {
        inq.prompt([{
            type: "input",
            message: "How many items would you like to purchase? Please enter a number: \n\n",
            name: "count"
        }]).then(function(data) {
            //take entry -> make number
                ...
                .then(function(answer) {
                    if (answer.confirmOrder === true) {
                        if (quant <= res[0].stock_quantity) {
                            response = "\n\nThank You! Your oders is processing now!\n.....\n.....\n.....\n.....\n.....\n";
